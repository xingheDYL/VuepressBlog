<template>
    <transition name="fade">
        <div v-if="visible" class="notification-wrapper">
            <img :src="$withBase('http://qiniu.dyl.fit/blog/person_lital.gif')" style="pointer-events: none;border: 1px solid #DDDDDD;width: 100%;"
            ...
            <div class="notification-content" style="display: none">
                <img :src="$withBase('http://qiniu.dyl.fit/blog/person_lital.gif')" style="border: 1px solid #DDDDDD;width: 100%;"
