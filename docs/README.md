...
.wrap {
    ...
    top: -120%;
    left: -1%;
    background: url(https://img.shields.io/github/stars/xingheDYL/VuepressBlog?style=social) right,url(https://img.shields.io/github/forks/xingheDYL/VuepressBlog?style=social) right;
    background-repeat: no-repeat, no-repeat;
    background-position-y: 20%, 20%;
    background-position-x: 86%, 98%;
}

/* 这个是主页上GitHub stars和forks的动态特效 */
/* .wrap {
  transition: all 2s;
}
.wrap:hover {
